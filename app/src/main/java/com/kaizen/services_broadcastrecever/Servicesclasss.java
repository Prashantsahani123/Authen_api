package com.kaizen.services_broadcastrecever;
...
import com.kaizen.authen_api.MainActivity;
import com.kaizen.authen_api.R;

public class Servicesclasss  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_servicesclasss);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(mBroadcastStringAction)) {
                ...
                mTextView.setText(mTextView.getText()
                        ...
                        + "\n\n");
                Intent stopIntent = new Intent(Servicesclasss.this,
